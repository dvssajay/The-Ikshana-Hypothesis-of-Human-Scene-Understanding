...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./Ikshana3G-3-Camvid-BS2/Ikshana3G-3.txt','w')
...
import os
path2models= "./Ikshana3G-3-Camvid-BS2/Ikshana3G-3_"
...
o = open('./Ikshana3G-3-Camvid-BS2/Ikshana3G-3-time.txt','w')
...
plt.legend()
plt.savefig('./Ikshana3G-3-Camvid-BS2/Ikshana3G-3.png', dpi = 300)
...
print(iou_sum/101)
o = open('./Ikshana3G-3-Camvid-BS2/Ikshana3G-3_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./Ikshana3G-3-Camvid-BS2/Ikshana3G-3_IOU_test.txt','w')
...
with open('./Ikshana3G-3-Camvid-BS2/plot.csv', 'w') as f:
    writer = csv.writer(f)

...
class IkshanaNet(nn.Module):
  def __init__(self):
    ...
    self.s1 = nn.Sequential(nn.Conv2d(192, 12, kernel_size=1, stride =1,bias=False),
                                   nn.BatchNorm2d(12),
                                   nn.ReLU(inplace=True))
    self.pool = nn.AvgPool2d(kernel_size=2)
    self.glance21 = look(in_filters=195, dilation_rate=1)
    self.glance22 = look(in_filters=227, dilation_rate=2)
    self.glance23 = look(in_filters=259, dilation_rate=3)
    self.glance24 = look(in_filters=291, dilation_rate=1)
    self.glance25 = look(in_filters=323, dilation_rate=2)
    self.glance26 = look(in_filters=355, dilation_rate=3)
    
    
    self.s2 = nn.Sequential(nn.Conv2d(384, 12, kernel_size=1, stride =1,bias=False),
                                   nn.BatchNorm2d(12),
                                  nn.ReLU(inplace=True))
    
    self.glance31 = look(in_filters=387, dilation_rate=1)
    self.glance32 = look(in_filters=419, dilation_rate=2)
    self.glance33 = look(in_filters=451, dilation_rate=3)
    self.glance34 = look(in_filters=483, dilation_rate=1)
    self.glance35 = look(in_filters=515, dilation_rate=2)
    self.glance36 = look(in_filters=547, dilation_rate=3)



    self.s3 = nn.Sequential(nn.Conv2d(576, 12, kernel_size=1, stride =1,bias=False),
                                  nn.BatchNorm2d(12),
                                  nn.ReLU(inplace=True))
...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./Ikshana6G-2-Camvid-BS2/Ikshana6G-2.txt','w')
...
import os 
path2models= "./Ikshana6G-2-Camvid-BS2/Ikshana6G-2_"
...
o = open('./Ikshana6G-2-Camvid-BS2/Ikshana6G-2-time.txt','w')
...
plt.legend()
plt.savefig('./Ikshana6G-2-Camvid-BS2/Ikshana6G-2.png', dpi = 300)
...
print(iou_sum/101)
o = open('./Ikshana6G-2-Camvid-BS2/Ikshana6G-2_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./Ikshana6G-2-Camvid-BS2/Ikshana6G-2_IOU_test.txt','w')
...
with open('./Ikshana6G-2-Camvid-BS2/plot.csv', 'w') as f:
    writer = csv.writer(f)

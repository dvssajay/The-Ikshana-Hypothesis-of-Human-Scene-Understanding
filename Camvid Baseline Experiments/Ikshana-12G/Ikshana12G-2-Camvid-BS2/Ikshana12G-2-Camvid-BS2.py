...
train , dump = torch.utils.data.random_split(train_ds, [183,184], generator=torch.Generator().manual_seed(42))
print(train)
print(dump)
...
class IkshanaNet(nn.Module):
  def __init__(self):
    ...
    self.glance17 = look(in_filters=195, dilation_rate=1)
    self.glance18 = look(in_filters=227, dilation_rate=2)
    self.glance19 = look(in_filters=259, dilation_rate=3)
    self.glance110 = look(in_filters=291, dilation_rate=1)
    self.glance111 = look(in_filters=323, dilation_rate=2)
    self.glance112 = look(in_filters=355, dilation_rate=3)


    self.s1 = nn.Sequential(nn.Conv2d(384, 12, kernel_size=1, stride =1,bias=False),
                                   nn.BatchNorm2d(12),
                                   nn.ReLU(inplace=True))
    self.pool = nn.AvgPool2d(kernel_size=2)
    self.glance21 = look(in_filters=387, dilation_rate=1)
    self.glance22 = look(in_filters=419, dilation_rate=2)
    self.glance23 = look(in_filters=451, dilation_rate=3)
    self.glance24 = look(in_filters=483, dilation_rate=1)
    self.glance25 = look(in_filters=515, dilation_rate=2)
    self.glance26 = look(in_filters=547, dilation_rate=3)
    self.glance27 = look(in_filters=579, dilation_rate=1)
    self.glance28 = look(in_filters=611, dilation_rate=2)
    self.glance29 = look(in_filters=643, dilation_rate=3)
    self.glance210 = look(in_filters=675, dilation_rate=1)
    self.glance211 = look(in_filters=707, dilation_rate=2)
    self.glance212 = look(in_filters=739, dilation_rate=3)
    
    
    self.s2 = nn.Sequential(nn.Conv2d(768, 12, kernel_size=1, stride =1,bias=False),
                                   nn.BatchNorm2d(12),
                                  nn.ReLU(inplace=True))
    
    self.glance31 = look(in_filters=771, dilation_rate=1)
    self.glance32 = look(in_filters=803, dilation_rate=2)
    self.glance33 = look(in_filters=835, dilation_rate=3)
    self.glance34 = look(in_filters=867, dilation_rate=1)
    self.glance35 = look(in_filters=899, dilation_rate=2)
    self.glance36 = look(in_filters=931, dilation_rate=3)
    self.glance37 = look(in_filters=963, dilation_rate=1)
    self.glance38 = look(in_filters=995, dilation_rate=2)
    self.glance39 = look(in_filters=1027, dilation_rate=3)
    self.glance310 = look(in_filters=1059, dilation_rate=1)
    self.glance311 = look(in_filters=1091, dilation_rate=2)
    self.glance312 = look(in_filters=1123, dilation_rate=3)



    self.s3 = nn.Sequential(nn.Conv2d(1152, 12, kernel_size=1, stride =1,bias=False),
                                  nn.BatchNorm2d(12),
                                  nn.ReLU(inplace=True))
...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./Ikshana12G-2-Camvid-BS2/Ikshana12G-2.txt','w')
...
import os 
path2models= "./Ikshana12G-2-Camvid-BS2/Ikshana12G-2_"
...
o = open('./Ikshana12G-2-Camvid-BS2/Ikshana12G-2-time.txt','w')
...
plt.legend()
plt.savefig('./Ikshana12G-2-Camvid-BS2/Ikshana12G-2.png', dpi = 300)
...
print(iou_sum/101)
o = open('./Ikshana12G-2-Camvid-BS2/Ikshana12G-2_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./Ikshana12G-2-Camvid-BS2/Ikshana12G-2_IOU_test.txt','w')
...
with open('./Ikshana12G-2-Camvid-BS2/plot.csv', 'w') as f:
    writer = csv.writer(f)

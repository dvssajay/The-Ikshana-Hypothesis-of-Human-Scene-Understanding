...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./Ikshana-Camvid-BS2/Ikshana-1.txt','w')
...
import os
path2models= "./Ikshana-Camvid-BS2/Ikshana-1_"
...
o = open('./Ikshana-Camvid-BS2/Ikshana-1-time.txt','w')
...
plt.legend()
plt.savefig('./Ikshana-Camvid-BS2/Ikshana-1.png', dpi = 300)
...
print(iou_sum/101)
o = open('./Ikshana-Camvid-BS2/Ikshana-1_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./Ikshana-Camvid-BS2/Ikshana-1_IOU_test.txt','w')
...
with open('./Ikshana-Camvid-BS2/plot.csv', 'w') as f:
    writer = csv.writer(f)

...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-1S-6G-4/IkshanaNet-1S-6G-4-Trainingset.txt','w')
...
import os
path2models= "./IkshanaNet-1S-6G-4/IkshanaNet-1S-6G-4-Trainingset_"
...
o = open('./IkshanaNet-1S-6G-4/IkshanaNet-1S-6G-4_time.txt','w')
...
plt.legend()
plt.savefig('./IkshanaNet-1S-6G-4/IkshanaNet-1S-6G-4.png', dpi = 300)
...
with open('./IkshanaNet-1S-6G-4/plot.csv', 'w') as f:
    writer = csv.writer(f)

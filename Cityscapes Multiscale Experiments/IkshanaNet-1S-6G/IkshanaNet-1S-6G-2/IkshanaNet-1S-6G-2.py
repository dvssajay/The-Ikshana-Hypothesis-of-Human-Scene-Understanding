...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-1S-6G-3-Training.txt','w')
...
import os
path2models= "./IkshanaNet-1S-6G-3_"
...
o = open('./IkshanaNet-1S-6G-3_time.txt','w')
...
torch.save(model.state_dict(), "IkshanaNet-1S-6G-3_M")
...
plt.legend()
plt.savefig('IkshanaNet-1S-6G-3.png', dpi = 300)

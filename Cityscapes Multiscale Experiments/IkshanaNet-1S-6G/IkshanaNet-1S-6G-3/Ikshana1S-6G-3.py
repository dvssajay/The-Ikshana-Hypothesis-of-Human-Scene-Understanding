...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-1S-6G-3/IkshanaNet-1S-6G-3-Trainingset.txt','w')
...
import os
path2models= "./IkshanaNet-1S-6G-3/IkshanaNet-1S-6G-3-Trainingset_"
...
o = open('./IkshanaNet-1S-6G-3/IkshanaNet-1S-6G-3_time.txt','w')
...
plt.legend()
plt.savefig('./IkshanaNet-1S-6G-3/IkshanaNet-1S-6G-3.png', dpi = 300)
...
with open('./IkshanaNet-1S-6G-3/plot.csv', 'w') as f:
    writer = csv.writer(f)

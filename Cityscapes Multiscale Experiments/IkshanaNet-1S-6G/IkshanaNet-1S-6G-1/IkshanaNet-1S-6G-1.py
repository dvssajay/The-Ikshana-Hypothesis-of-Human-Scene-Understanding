...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-1S-6G-2-Training.txt','w')
...
import os
path2models= "./IkshanaNet-1S-6G-2_"
...
o = open('./IkshanaNet-1S-6G-2_time.txt','w')
...
torch.save(model.state_dict(), "IkshanaNet-1S-6G-2_M")
...
plt.legend()
plt.savefig('IkshanaNet-1S-6G-2.png', dpi = 300)

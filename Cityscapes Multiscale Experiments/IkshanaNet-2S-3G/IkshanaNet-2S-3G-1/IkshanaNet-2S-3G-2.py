...
train , dump = torch.utils.data.random_split(train_ds, [1487,1488], generator=torch.Generator().manual_seed(42))
...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-2S-3G-2-Training.txt','w')
...
import os
path2models= "./IkshanaNet-2S-3G-2_"
...
o = open('./IkshanaNet-2S-3G-2_time.txt','w')
...
torch.save(model.state_dict(), "IkshanaNet-2S-3G-2_M")
...
plt.legend()
plt.savefig('IkshanaNet-2S-3G-2.png', dpi = 300)

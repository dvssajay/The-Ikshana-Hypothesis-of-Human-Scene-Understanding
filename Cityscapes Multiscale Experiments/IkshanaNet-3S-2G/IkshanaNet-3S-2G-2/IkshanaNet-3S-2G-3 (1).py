...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-3S-2G-3.txt','w')
...
import os
path2models= "./IkshanaNet-3S-2G-3_"
...
o = open('./IkshanaNet-3S-2G-3_time.txt','w')
...
torch.save(model.state_dict(), "IkshanaNet-3S-2G-3_M")
...
plt.legend()
plt.savefig('IkshanaNet-3S-2G-3.png', dpi = 300)

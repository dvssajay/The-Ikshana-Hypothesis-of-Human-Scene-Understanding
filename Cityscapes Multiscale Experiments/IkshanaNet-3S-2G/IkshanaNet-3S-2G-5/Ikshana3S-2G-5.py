...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-3S-2G-5/IkshanaNet-3S-2G-5-Trainingset.txt','w')
...
import os
path2models= "./IkshanaNet-3S-2G-5/IkshanaNet-3S-2G-5-Trainingset_"
...
o = open('./IkshanaNet-3S-2G-5/IkshanaNet-3S-2G-5_time.txt','w')
...
plt.legend()
plt.savefig('./IkshanaNet-3S-2G-5/IkshanaNet-3S-2G-5.png', dpi = 300)
...
with open('./IkshanaNet-3S-2G-5/plot.csv', 'w') as f:
    writer = csv.writer(f)

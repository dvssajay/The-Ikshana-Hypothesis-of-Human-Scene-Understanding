...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-6/IkshanaNet-6-Trainingset.txt','w')
...
import os
path2models= "./IkshanaNet-6/IkshanaNet-6-Trainingset_"
...
o = open('./IkshanaNet-6/IkshanaNet-6_time.txt','w')
...
plt.legend()
plt.savefig('./IkshanaNet-6/IkshanaNet-6.png', dpi = 300)
...
with open('./IkshanaNet-6/plot.csv', 'w') as f:
    writer = csv.writer(f)

...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-5/IkshanaNet-5-Trainingset.txt','w')
...
import os
path2models= "./IkshanaNet-5/IkshanaNet-5-Trainingset_"
...
o = open('./IkshanaNet-5/IkshanaNet-5_time.txt','w')
...
plt.legend()
plt.savefig('./IkshanaNet-5/IkshanaNet-5.png', dpi = 300)
...
with open('./IkshanaNet-5/plot.csv', 'w') as f:
    writer = csv.writer(f)

...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-main-Half-Trainingset.txt','w')
...
import os
path2models= "./IkshanaNet-main-Half-Trainingset_"
...
o = open('./IkshanaNet-main-Half-Trainingset_time.txt','w')
...
torch.save(model.state_dict(), "IkshanaNet-main-Half-Trainingset_M")
...
plt.legend()
plt.savefig('IkshanaNet-main-Half-Trainingset.png', dpi = 300)

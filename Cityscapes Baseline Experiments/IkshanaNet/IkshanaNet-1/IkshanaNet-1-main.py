...
train = myCityscapes("./", split='train', mode='fine',target_type='semantic', transforms=transform_train,target_transform=None)
           #transforms=None)
...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./IkshanaNet-Full-Trainingset.txt','w')
...
import os
path2models= "./IkshanaNet-Full-Trainingset_"
...
o = open('./IkshanaNet-Full-Trainingset_time.txt','w')
...
torch.save(model.state_dict(), "IkshanaNet-Full-Trainingset_M")
...
plt.legend()
plt.savefig('IkshanaNet-Full-Trainingset.png', dpi = 300)

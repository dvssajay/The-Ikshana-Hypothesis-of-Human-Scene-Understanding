...
def train_val(model, params):
    ...
    best_loss=float('inf')
    o = open('./Ikshana-3S-2G-2-Camvid-BS2/Ikshana-3S-2G-2.txt','w')
...
import os 
path2models= "./Ikshana-3S-2G-2-Camvid-BS2/Ikshana-3S-2G-2_"
...
o = open('./Ikshana-3S-2G-2-Camvid-BS2/Ikshana-3S-2G-2-time.txt','w')
...
plt.legend()
plt.savefig('./Ikshana-3S-2G-2-Camvid-BS2/Ikshana-3S-2G-2.png', dpi = 300)
...
print(iou_sum/101)
o = open('./Ikshana-3S-2G-2-Camvid-BS2/Ikshana-3S-2G-2_IOU_val.txt','w')
...
print(i_sum/233)
o = open('./Ikshana-3S-2G-2-Camvid-BS2/Ikshana-3S-2G-2_IOU_test.txt','w')
...
with open('./Ikshana-3S-2G-2-Camvid-BS2/plot.csv', 'w') as f:
    writer = csv.writer(f)
